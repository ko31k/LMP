...
maxsm_omdb_oscars: {
    uk: '<img src="https://www.streamingdiscovery.com/logo/oscar.png" style="height:14px; width:auto; display:inline-block; vertical-align:middle; object-fit:contain; transform:scale(1.2); filter: grayscale(100%);">'
},
        // ДОДАНО: Переклади для нових типів нагород
        // Emmy
maxsm_omdb_emmy: {
    uk: '<img src="https://www.streamingdiscovery.com/logo/emmy-awards.png" style="height:12px; width:auto; display:inline-block; vertical-align:middle; transform:scale(1.0); filter: grayscale(100%);">'
},
...
source_imdb: {
    uk: '<img src="https://www.streamingdiscovery.com/logo/imdb.png" style="height:14px; width:auto; display:inline-block; vertical-align:middle; object-fit:contain; transform:scale(1.2); filter: grayscale(100%);">'
},
source_tmdb: {
    uk: '<img src="https://www.streamingdiscovery.com/logo/tmdb.png" style="height:14px; width:auto; display:inline-block; vertical-align:middle; object-fit:contain; transform:scale(1.2); filter: grayscale(100%);">'
},
source_rt: {
    uk: '<img src="https://www.streamingdiscovery.com/logo/rotten-tomatoes.png" style="height:14px; width:auto; display:inline-block; vertical-align:middle; object-fit:contain; transform:scale(1.2); filter: grayscale(100%);">'
},
source_mc: {
    uk: '<img src="https://www.streamingdiscovery.com/logo/metacritic.png" style="height:14px; width:auto; display:inline-block; vertical-align:middle; object-fit:contain; transform:scale(1.2); filter: grayscale(100%);">'
}
    });
